...
@section('content')
    <main class="font-fredoka space-y-14">
      <section class="h-screen">
        <div
          class="p-4 relative h-full w-full flex items-center justify-center"
        >
          <!-- Hero bagian kiri -->
          <img
            class="top-0 left-0 absolute md:h-[initial] h-32"
            src="/images/hero-head.png"
            alt="hero-head"
          />
          <img
            src="/images/hero-1.png"
            class="absolute md:block lg:h-[initial] md:h-80 hidden inset-y-0 my-auto left-0"
            alt="hero-1"
          />
          ...
          <img
            ...
            class="absolute top-0 right-0 md:block lg:h-[initial] md:h-80 hidden"
            alt="hero-2"
          />
          <img
            src="/images/hero-3.png"
            class="absolute bottom-[-10%] right-0 md:block lg:h-[initial] md:h-80 hidden"
            alt="hero-3"
          />
          <div class="flex flex-col items-center space-y-3.5">
            <img
              class="h-80 lg:h-96 w-fit object-contain z-30"
              alt="hero"
              src="/images/hero.png"
            />
        ...
        <div class="pl-4 py-4 space-y-7 flex flex-col justify-center">
          ...
          <div class="w-full overflow-auto flex items-center space-x-10">
            <div class="w-[49.188rem] h-[30.875rem] relative shrink-0">
              <img
                src="/images/kegiatan/kegiatan-1.png"
                class="w-full h-full object-cover rounded-lg"
                alt="kegiatan-1"
              />

              <div
                class="w-full h-full bg-black/50 absolute inset-0 m-auto rounded-lg z-10"
              >
                <span
      ...
      <section>
        <div
          class="max-w-[84rem] mx-auto flex w-full items-center p-4 md:space-x-16"
        >
          <img
            src="/images/upaya/ilustrasi.png"
            class="lg:h-[36rem] h-96 w-full hidden md:block object-contain"
            alt="ilustrasi"
          />
          ...
          <div class="space-y-7">
            ...
            <div class="relative">
              <span
                class="absolute -top-4 -left-4 bg-brand-secondary w-64 h-24 block rounded-lg"
              ></span>
              ...
              <span
                class="absolute -bottom-4 -right-4 bg-brand-secondary w-64 h-24 block rounded-lg"
              ></span>
            </div>
          </div>
        </div>
      ...
      <section class="!-mt-7">
        <div
          class="pl-4 flex items-center h-full w-full justify-between space-x-5"
        >
          <div>
            ...
            <div class="space-y-3">
              ...
              <div class="relative">
                ...
                <div class="bg-brand-primary p-4 rounded-lg relative z-10">
                  <p
                    class="text-white text-justify font-semibold text-lg max-w-5xl"
                  >
          ...
          <div class="h-[32rem] w-fit relative">
            <img
              src="/images/philantropal/ilustrasi.png"
              class="h-full w-full md:block hidden object-contain"
