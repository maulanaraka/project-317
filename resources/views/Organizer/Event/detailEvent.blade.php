    ...
    <div class="pt-20">
        <div class="relative bg-zinc-100 overflow-hidden w-full max-w-5xl mx-auto my-16 p-8 rounded-3xl shadow">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <ul class="space-y-4">
                    <li class="text-lg font-semibold text-zinc-500 font-fredoka">Description: <span
                            class="font-normal">{{ $event->description }}</span></li>
                    <li class="text-lg font-semibold text-zinc-500 font-fredoka">Event Date: <span
                    ...
                    <li class="text-lg font-semibold text-zinc-500 font-fredoka">WhatsApp: <a
                            href="https://wa.me/{{ $event->phone }}" target="_blank"
                            class="text-blue-500">{{ $event->phone }}</a></li>
                    ...
                    <li class="text-lg font-semibold text-zinc-500 font-fredoka">Status: <span
                            class="{{ $event->event_status ? 'text-green-500' : 'text-red-500' }}">{{ $event->event_status ? 'Approved' : 'Pending' }}</span>
                    </li>
                </ul>
            </div>
        </div>
