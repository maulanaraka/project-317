...
<<<<<<< HEAD
                ...
                <form action="/organizer/addEvent" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="description" class="block text-base font-semibold text-zinc-500 font-fredoka">Description</label>
                            <textarea name="description" id="description" placeholder="Description"
                                class="mt-1 border border-zinc-600 block w-full py-2 px-4 rounded-lg font-fredoka" rows="4"></textarea>
                        </div>
        
                        <div>
                            <label for="event_date" class="block text-base font-semibold text-zinc-500 font-fredoka">Event Date</label>
                        ...
                        <div>
                            ...
                            <input type="file" name="media" id="media" class="mt-1 block w-full py-2 px-4 rounded-lg bg-zinc-300 font-fredoka">
                        </div>
        
                        <div>
                            <label for="event_category" class="block text-base font-semibold text-zinc-500 font-fredoka">Category</label>
...
>>>>>>> e8bbdb0c9fc1fe18f4deb9cab4fca6eb003afe68
        </div>
    </div>
