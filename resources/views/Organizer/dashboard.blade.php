...
@section('content')
    ...
    {{-- navbar start --}}
    <nav
        class='fixed inset-x-0 top-0 mx-auto w-full border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-xl md:w-5/6 font-[Montserrat] z-20'>
            ...
            <ul id="collapseMenu"
                ...
                <li class='max-lg:border-b max-lg:py-2'>
                    <a href='/organizer/dashboard'
                        class='{{ Str::contains(Route::currentRouteName(), 'dashboardOrg') ? 'hover:font-bold font-semibold block text-[15px] lg:border-b-2 lg:border-[#000000]' : 'hover:font-bold text-gray-600 font-reguler text-[15px]' }}'>Dashboard</a>
                </li>
                <li class='max-lg:border-b max-lg:py-2'>
                    <a href='#'
                        class='{{ Str::contains(Route::currentRouteName(), '#') ? 'hover:font-bold font-semibold block text-[15px] lg:border-b-2 lg:border-[#000000]' : 'hover:font-bold text-gray-600 font-reguler text-[15px]' }}'>Forum</a>
                </li>
                <li class='max-lg:border-b max-lg:py-2'>
                    <a href='/organizer/formAddEvent'
                        class='{{ Str::contains(Route::currentRouteName(), 'addEventOrg') ? 'hover:font-bold font-semibold block text-[15px] lg:border-b-2 lg:border-[#000000]' : 'hover:font-bold text-gray-600 font-reguler text-[15px]' }}'>Tambah
                        Event</a>
                </li>
                <li class='max-lg:border-b max-lg:py-2'>
                    <a href='/organizer/listMyEvent'
                        class='{{ Str::contains(Route::currentRouteName(), 'eventOrg') ? 'hover:font-bold font-semibold block text-[15px] lg:border-b-2 lg:border-[#000000]' : 'hover:font-bold text-gray-600 font-reguler text-[15px]' }}'>Event
                        Saya</a>
                </li>
                <li class="relative">
                    <button
    ...
    <div class="relative overflow-hidden bg-cover bg-no-repeat p-12 text-center h-screen max-w-screen"
        style="background-image: url('{{ asset('img/facility (2).jpg') }}')">
        ...
        <div class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed mt-10">
            <div class="flex h-full items-center justify-center">
                <div class="text-white">
                    <p class="mt-8 mb-4 text-lg font-normal text-white lg:text-3xl sm:px-16 lg:px-48">Temukan Kenangan Tak
                        Terlupakan di Hotel Kami
                    </p>
                    <h1
                        class="mb-8 text-4xl font-bold tracking-tight leading-none text-white md:text-5xl lg:text-6xl font-[Aleo]">
    ...
    {{-- carousel --}}
    <div class="overflow-auto flex items-center space-x-10">
