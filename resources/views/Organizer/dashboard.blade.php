...
@section('content')
    ...
    <div class="py-8 px-8">
        <a href='/explore'>
        <button class="hover:bg-sky-500 bg-green text-white font-bold py-2 px-4 rounded-xl">
            Lihat Event Lainnya
        </button>
        </a>
        ...
        <div class="grid grid-cols-2 gap-8">
            ...
            <div class="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm flex items-center">
                ...
                <div>
                    ...
                    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-green rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300">
                        Read more
            ...
            <div class="max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm flex items-center">
                ...
                <div>
                    ...
                    <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-green rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                        Read more
                        <svg class="w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                        </svg>
