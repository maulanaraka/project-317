            ...
            <div class="">
                ...
                <form action="/organizer/updateProfile" method="POST">
                    ...
                    <div class="w-full rounded-lg bg-blue-500 mt-4 text-black text-lg font-semibold">
                        <a href="/4dm1n/{{$dataProfile->id}}/formUpdateProfile" class="bg-white border border-gray-400 block py-2 px-4 w-full rounded font-fredoka z-20">Update</a>
                        </div>
                </form>
            </div>
        </div>
...
<!-- <div class="w-1/2 h-1/2 m-auto border-2 border-black p-32 ">
    ...
    <a href="/4dm1n/{{$dataProfile->id}}/formUpdateProfile" class="p-1 border-2 border-black text-center rounded-xl">Update</a>
