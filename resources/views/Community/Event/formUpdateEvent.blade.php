...
@section('content')
    ...
    <div class="pt-20">
        <div class="relative bg-zinc-100 overflow-hidden w-full max-w-5xl mx-auto my-16 p-8 rounded-3xl shadow">
            <div class="mb-8">
                <p class="text-6xl font-medium text-stone-400 text-justify font-['Fredoka']">From Login Community</p>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" placeholder="Description"
                            class="mt-1 border border-zinc-600 block w-full py-2 px-4 rounded-lg font-fredoka" rows="4">{{ old('description', $myEvent->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="event_date" id="event_date"
                            ...
                            value="{{ old('event_date', $myEvent->event_date) }}">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="event_category" id="event_category"
                            ...
                            @foreach ($category as $cl)
                                <option value="{{ $cl->id }}"
                                    {{ $myEvent->event_category == $cl->id ? 'selected' : '' }}>{{ $cl->category_name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
